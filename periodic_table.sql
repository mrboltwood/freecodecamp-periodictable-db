...
ALTER TABLE ONLY public.properties DROP CONSTRAINT properties_type_id_fkey;
ALTER TABLE ONLY public.properties DROP CONSTRAINT properties_atomic_number_fkey;
ALTER TABLE ONLY public.types DROP CONSTRAINT types_pkey;
ALTER TABLE ONLY public.properties DROP CONSTRAINT properties_pkey;
ALTER TABLE ONLY public.properties DROP CONSTRAINT properties_atomic_number_key;
ALTER TABLE ONLY public.elements DROP CONSTRAINT elements_symbol_key;
ALTER TABLE ONLY public.elements DROP CONSTRAINT elements_pkey;
ALTER TABLE ONLY public.elements DROP CONSTRAINT elements_name_key;
ALTER TABLE ONLY public.elements DROP CONSTRAINT elements_atomic_number_key;
